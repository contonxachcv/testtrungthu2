...
function S() {
    let e = "";
    try {
        e = new URLSearchParams(location.search).get("api") || ""
    } catch {}
    return String(e || void 0 || "https://apiv2.deargift.online/api/v2").replace(/\/+$/, "")
}
const T = S()
  , y = "https://deargift.vn"
  , C = {
...
function d({status: e, body: t}) {
    var a, n, i, o;
    if (e === 200 && (t != null && t.success) && t.data)
        return {
            trangThai: "ok",
            config: t.data
        };
    if (t != null && t.expired)
        return {
            trangThai: "expired",
            thongDiep: t.message || "Thiệp này đã hết hạn."
        };
    const s = ((a = t == null ? void 0 : t.error) == null ? void 0 : a.code) || (t == null ? void 0 : t.code) || "";
    return e === 403 && (s === "payment_required" || t != null && t.paymentRequired) ? {
        trangThai: "payment_required",
        thongDiep: ((n = t == null ? void 0 : t.error) == null ? void 0 : n.message) || (t == null ? void 0 : t.message) || "Thiệp chưa được thanh toán."
    } : e === 404 || s === "not_found" ? {
        trangThai: "not_found",
        thongDiep: "Không tìm thấy thiệp này."
    } : e === 403 ? {
        trangThai: "not_found",
        thongDiep: ((i = t == null ? void 0 : t.error) == null ? void 0 : i.message) || (t == null ? void 0 : t.message) || "Thiệp chưa được kích hoạt."
    } : {
        trangThai: "loi",
        thongDiep: ((o = t == null ? void 0 : t.error) == null ? void 0 : o.message) || (t == null ? void 0 : t.message) || "Không tải được thiệp, thử lại sau."
    }
}
function L(e=location) {
    ...
    let f = "";
    const m = (e.search || "").replace(/^\?+/, "").trim();
    if (m) {
        const A = m.split("&")[0].trim()
          , [h,O] = A.split("=");
        h && O === void 0 && /^[a-z0-9]{6,64}$/i.test(h) && (f = h)
    }
    return {
        preview: s,
        embed: a,
...
async function j() {
    ...
    if (e.preview) {
        ...
        try {
            const s = localStorage.getItem(C.CONFIG);
            if (s)
                return {
                    trangThai: "preview",
                    config: JSON.parse(s),
    ...
    try {
        if (e.slug) {
            const t = await w(`${T}/access/by-slug/${p}/${encodeURIComponent(e.slug)}`);
            return {
                ...d(t),
                diaChi: e
            }
        ...
        if (e.websiteId) {
            const t = await w(`${T}/access/${p}/${encodeURIComponent(e.websiteId)}`);
            return {
                ...d(t),
                diaChi: e
            }
        ...
        return {
            trangThai: "loi",
            thongDiep: (t == null ? void 0 : t.name) === "AbortError" ? "Mạng chậm quá, không tải được thiệp. Thử tải lại trang." : "Không kết nối được máy chủ.",
            diaChi: e
        }
    }
    return {
...
const r = new URLSearchParams(typeof location > "u" ? "" : location.search)
  , b = new Set((r.get("off") || "").split(",").filter(Boolean));
function z() {
    return !1
}
function v() {
    ...
    if (e === "low")
        return "yeu";
    if (e === "high" || typeof navigator > "u" || typeof window > "u")
        return "manh";
...
const W = 95
  ...
  , ft = b.has("rabbits") ? [_] : G.flatMap(e => [_, e]);
export {T as A, ut as C, l as D, J as F, st as H, u as I, ft as L, ot as O, y as P, lt as R, C as S, p as T, H as a, $ as b, q as c, F as d, ht as e, z as f, V as g, gt as h, ct as i, X as j, W as k, k as l, Q as m, tt as n, Z as o, K as p, nt as q, et as r, it as s, rt as t, at as u, b as v, Y as w, j as x};
