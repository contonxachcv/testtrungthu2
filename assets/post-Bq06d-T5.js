import {R as Y, r as A, u as fe, i as Ue, a as we, j as q, e as De} from "./fiber-D1tVm3tX.js";
import {U as O, d as x, F as T, G as Z, H as ye, J as Ae, K as pe, X as U, x as K, Y as Ce, r as ve, Z as X, _ as L, $ as te, a0 as me, a1 as ge, S as ne, O as Pe, p as Ie, a2 as V, D as W, a3 as F, a4 as Oe, a5 as G, a6 as p, a7 as Se, w as Te, a8 as Ee, P as Fe, a9 as Ne, aa as ze, ab as ae, z as le, ac as He, N as Ge} from "./three-CbMnaw2G.js";
/**
...
var Le = ( () => {
    const e = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0])
      ...
      , s = new ze;
    return s.setAttribute("position", new ae(e,3)),
    s.setAttribute("uv", new ae(t,2)),
    s
}
)()
  , b = class J {
    ...
    set fullscreenMaterial(t) {
        let s = this.screen;
        s !== null ? s.material = t : (s = new Ie(J.fullscreenGeometry,t),
        s.frustumCulled = !1,
        this.scene === null && (this.scene = new ne),
        this.scene.add(s),
        this.screen = s)
    }
...
gl_FragDepth=readDepth(vUv);
  ...
  , be = class extends F {
    ...
    set inputBuffer(e) {
        const t = e !== null;
        this.colorWrite !== t && (t ? this.defines.COLOR_WRITE = !0 : delete this.defines.COLOR_WRITE,
        this.colorWrite = t,
        this.needsUpdate = !0),
    ...
    set depthBuffer(e) {
        const t = e !== null;
        this.depthWrite !== t && (t ? this.defines.DEPTH_WRITE = !0 : delete this.defines.DEPTH_WRITE,
        this.depthTest = t,
        this.depthWrite = t,
        this.needsUpdate = !0),
    ...
    set colorSpaceConversion(e) {
        this.colorSpaceConversion !== e && (e ? this.defines.COLOR_SPACE_CONVERSION = !0 : delete this.defines.COLOR_SPACE_CONVERSION,
        this.needsUpdate = !0)
    }
    get channelWeights() {
    ...
    set channelWeights(e) {
        e !== null ? (this.defines.USE_WEIGHTS = "1",
        this.uniforms.channelWeights.value = e) : delete this.defines.USE_WEIGHTS,
        this.needsUpdate = !0
    }
    setInputBuffer(e) {
        this.uniforms.inputBuffer.value = e
  ...
  , We = class extends b {
    constructor(e, t=!0) {
        super("CopyPass"),
        this.fullscreenMaterial = new be,
        this.needsSwap = !1,
        this.renderTarget = e,
        e === void 0 && (this.renderTarget = new U(1,1,{
            minFilter: K,
            magFilter: K,
            stencilBuffer: !1,
            depthBuffer: !1
    ...
    initialize(e, t, s) {
        s !== void 0 && (this.renderTarget.texture.type = s,
        s !== O ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : e !== null && e.outputColorSpace === T && (this.renderTarget.texture.colorSpace = T))
    }
}
  , oe = new ve
  , Re = class extends b {
    ...
    render(e, t, s, i, r) {
        const n = this.overrideClearColor
          ...
          , o = n !== null
          , c = a >= 0;
        o ? (e.getClearColor(oe),
        e.setClearColor(n, c ? a : l)) : c && e.setClearAlpha(a),
        e.setRenderTarget(this.renderToScreen ? null : t),
        e.clear(this.color, this.depth, this.stencil),
        o ? e.setClearColor(oe, l) : c && e.setClearAlpha(l)
    }
}
  , Ke = class extends b {
    constructor(e, t) {
    ...
    render(e, t, s, i, r) {
        ...
        a.stencil.setFunc(n.ALWAYS, d, 4294967295),
        ...
        e.render(l, o)) : (e.setRenderTarget(t),
        e.render(l, o),
        e.setRenderTarget(s),
        e.render(l, o)),
        a.color.setLocked(!1),
...
function Xe(e, t) {
    ...
    if (t <= 0 || typeof s.renderbufferStorageMultisample != "function")
        return 0;
    ...
    try {
        return s.bindRenderbuffer(s.RENDERBUFFER, a),
        s.renderbufferStorageMultisample(s.RENDERBUFFER, r, s.RGBA8, 1, 1),
        r
    } catch {
        return 0
    } finally {
        s.bindRenderbuffer(s.RENDERBUFFER, n),
        s.deleteRenderbuffer(a)
    }
}
var $ = 1 / 1e3
  , je = 1e3
  ...
  , $e = class {
    constructor(t=null, {depthBuffer: s=!0, stencilBuffer: i=!1, multisampling: r=0, frameBufferType: n=O}={}) {
        this.renderer = null,
        this.inputBuffer = this.createBuffer(s, i, n, r),
        this.outputBuffer = this.inputBuffer.clone(),
        this.copyPass = new We,
    ...
    set multisampling(t) {
        ...
        this.multisampling !== s && (this.inputBuffer.samples = s,
        this.outputBuffer.samples = s,
    ...
    setRenderer(t) {
        ...
        t !== null) {
            ...
            r === O && t.outputColorSpace === T && (this.inputBuffer.texture.colorSpace = T,
            this.outputBuffer.texture.colorSpace = T,
            this.inputBuffer.dispose(),
            this.outputBuffer.dispose());
            const n = this.multisampling;
            this.multisampling = n,
            t.autoClear = !1,
    ...
    replaceRenderer(t, s=!0) {
        ...
        return this.setRenderer(t),
        s && r !== null && (r.removeChild(i.domElement),
        r.appendChild(t.domElement)),
        i
    }
    createDepthTexture() {
        const t = new Z;
        t.name = "EffectComposer.InputDepth",
        this.inputBuffer.stencilBuffer ? (t.format = ye,
        t.type = Ae) : t.type = pe;
        const s = new Z;
        s.format = t.format,
        s.type = t.type,
        s.name = "EffectComposer.OutputDepth";
        const i = new Z;
        i.format = t.format,
        i.type = t.type,
        i.name = "EffectComposer.StableDepth",
        this.inputBuffer.depthTexture = t,
        this.outputBuffer.depthTexture = s,
        this.inputBuffer.dispose(),
        this.outputBuffer.dispose();
        const {width: r, height: n} = this.inputBuffer;
    ...
    blitDepthBuffer(t) {
        ...
        n.bindFramebuffer(n.READ_FRAMEBUFFER, a),
        n.bindFramebuffer(n.DRAW_FRAMEBUFFER, l),
        n.blitFramebuffer(0, 0, t.width, t.height, 0, 0, i.width, i.height, o, n.NEAREST),
    ...
    deleteDepthTexture() {
        ...
        for (const s of this.passes)
            s.getDepthTexture() === t && s.setDepthTexture(null);
        this.depthRenderTarget !== null && (this.depthRenderTarget.dispose(),
        this.depthRenderTarget = null),
        this.inputBuffer.depthTexture !== null && (this.inputBuffer.depthTexture.dispose(),
        this.inputBuffer.depthTexture = null),
        this.outputBuffer.depthTexture !== null && (this.outputBuffer.depthTexture.dispose(),
    ...
    createBuffer(t, s, i, r) {
        ...
        return i === O && n !== null && n.outputColorSpace === T && (l.texture.colorSpace = T),
    ...
    addPass(t, s) {
        ...
        t.renderToScreen && (this.autoRenderToScreen = !1)),
        s !== void 0 ? i.splice(s, 0, t) : i.push(t),
        this.autoRenderToScreen && (i[i.length - 1].renderToScreen = !0),
        t.needsDepthTexture || this.depthRenderTarget !== null)
            if (this.depthRenderTarget === null) {
                this.createDepthTexture();
                for (const o of i)
                    o.setDepthTexture(this.stableDepthTexture)
            } else
                t.setDepthTexture(this.stableDepthTexture)
    }
    removePass(t) {
        const s = this.passes
          , i = s.indexOf(t);
        if (i !== -1 && s.splice(i, 1).length > 0) {
            ...
            if (a !== null) {
                ...
                s.reduce(l, !1) || (t.getDepthTexture() === a && t.setDepthTexture(null),
                this.deleteDepthTexture())
            }
            this.autoRenderToScreen && i === s.length && (t.renderToScreen = !1,
            s.length > 0 && (s[s.length - 1].renderToScreen = !0))
        }
    }
    removeAllPasses() {
        const t = this.passes;
        this.deleteDepthTexture(),
        t.length > 0 && (this.autoRenderToScreen && (t[t.length - 1].renderToScreen = !1),
        this.passes = [])
    }
    render(t) {
        const s = this.renderer
          , i = this.copyPass;
        let r = this.inputBuffer, n = this.outputBuffer, a, l = !1;
        t === void 0 && (this.timer.update(),
        t = this.timer.getDelta());
        for (const o of this.passes)
            if (o.enabled) {
                if (o.render(s, r, n, t, l),
                o.needsDepthBlit && this.depthRenderTarget !== null && this.blitDepthBuffer(r),
                o.needsSwap) {
                    if (l) {
                        i.renderToScreen = o.renderToScreen;
                        const c = s.getContext()
                          , d = s.state.buffers.stencil;
                        d.setFunc(c.NOTEQUAL, 1, 4294967295),
                        i.render(s, r, n, t, l),
                        d.setFunc(c.EQUAL, 1, 4294967295)
                    }
                    a = r,
                    r = n,
                    n = a
    ...
    setSize(t, s, i) {
        const r = this.renderer
          , n = r.getSize(new x);
        (t === void 0 || s === void 0) && (t = n.width,
        s = n.height),
        (n.width !== t || n.height !== s) && r.setSize(t, s, i);
        const a = r.getDrawingBufferSize(new x);
        this.inputBuffer.setSize(a.width, a.height),
        this.outputBuffer.setSize(a.width, a.height),
        this.depthRenderTarget !== null && this.depthRenderTarget.setSize(a.width, a.height);
  ...
  , Qe = class {
    constructor() {
        this.shaderParts = new Map([[f.FRAGMENT_HEAD, null], [f.FRAGMENT_MAIN_UV, null], [f.FRAGMENT_MAIN_IMAGE, null], [f.VERTEX_HEAD, null], [f.VERTEX_MAIN_SUPPORT, null]]),
        this.defines = new Map,
        this.uniforms = new Map,
        this.blendModes = new Map,
        this.extensions = new Set,
        this.attributes = C.NONE,
  ...
  , ce = class {
    constructor(e=null) {
        ...
        this.replaceMaterial = t => {
            if (t.isMesh) {
                ...
                t.isSkinnedMesh ? t.material = s[2] : t.isInstancedMesh ? t.material = s[1] : t.material = s[0],
                ++this.meshCount
            }
        }
    }
    cloneMaterial(e) {
        ...
        for (const r in t) {
            const n = t[r].value;
            n.isRenderTargetTexture && (t[r].value = null,
            s.set(r, n))
        }
        const i = e.clone();
        for (const r of s)
            t[r[0]].value = r[1],
            i.uniforms[r[0]].value = r[1];
        return i
    }
    setMaterial(e) {
        ...
        e !== null) {
            ...
            for (const s of t)
                s.uniforms = Object.assign({}, e.uniforms),
                s.side = Oe;
            t[2].skinning = !0,
            this.materialsBackSide = t.map(s => {
  ...
  , E = class extends te {
    constructor(e=null, t=I, s=I, i=1) {
        super(),
        e !== null && this.addEventListener("change", () => e.setSize(this.baseSize.width, this.baseSize.height)),
        this.baseSize = new x(1,1),
        this.preferredSize = new x(t,s),
        this.target = this.preferredSize,
        this.s = i,
        this.effectiveSize = new x,
    ...
    updateEffectiveSize() {
        const e = this.baseSize
          ...
          , i = this.scale;
        t.width !== I ? s.width = t.width : t.height !== I ? s.width = Math.round(t.height * (e.width / Math.max(e.height, 1))) : s.width = Math.round(e.width * i),
        t.height !== I ? s.height = t.height : t.width !== I ? s.height = Math.round(t.width / Math.max(e.width / Math.max(e.height, 1), 1)) : s.height = Math.round(e.height * i)
    }
    get width() {
    ...
    set scale(e) {
        this.s !== e && (this.s = e,
        this.preferredSize.setScalar(I),
        this.dispatchEvent({
            type: "change"
        }))
    }
  ...
  , Dt = new Map([[u.ADD, Ye], [u.ALPHA, qe], [u.AVERAGE, Je], [u.COLOR, et], [u.COLOR_BURN, tt], [u.COLOR_DODGE, st], [u.DARKEN, it], [u.DIFFERENCE, rt], [u.DIVIDE, nt], [u.DST, null], [u.EXCLUSION, at], [u.HARD_LIGHT, lt], [u.HARD_MIX, ot], [u.HUE, ct], [u.INVERT, ut], [u.INVERT_RGB, dt], [u.LIGHTEN, ht], [u.LINEAR_BURN, ft], [u.LINEAR_DODGE, pt], [u.LINEAR_LIGHT, vt], [u.LUMINOSITY, mt], [u.MULTIPLY, gt], [u.NEGATION, St], [u.NORMAL, Tt], [u.OVERLAY, Et], [u.PIN_LIGHT, xt], [u.REFLECT, bt], [u.SATURATION, Rt], [u.SCREEN, Mt], [u.SOFT_LIGHT, _t], [u.SRC, Bt], [u.SUBTRACT, Ut], [u.VIVID_LIGHT, wt]])
  , yt = class extends te {
    constructor(e, t=1) {
        super(),
        this._blendFunction = e,
        this.opacity = new p(t)
    }
    getOpacity() {
  ...
  , ee = class extends te {
    constructor(e, t, {attributes: s=C.NONE, blendFunction: i=u.NORMAL, defines: r=new Map, uniforms: n=new Map, extensions: a=null, vertexShader: l=null}={}) {
        super(),
        this.name = e,
        this.renderer = null,
        this.attributes = s,
        ...
        this.uniforms = n,
        this.extensions = a,
        this.blendMode = new yt(i),
        this.blendMode.addEventListener("change", o => this.setChanged()),
        this._inputColorSpace = me,
...
#include <colorspace_fragment>
  ...
  , Ot = class extends b {
    constructor({kernelSize: e=se.MEDIUM, resolutionScale: t=.5, width: s=E.AUTO_SIZE, height: i=E.AUTO_SIZE, resolutionX: r=s, resolutionY: n=i}={}) {
        super("KawaseBlurPass"),
        this.renderTargetA = new U(1,1,{
            depthBuffer: !1
        }),
        ...
        this._blurMaterial = new It,
        this._blurMaterial.kernelSize = e,
        this.copyMaterial = new be
    }
    getResolution() {
    ...
    initialize(e, t, s) {
        s !== void 0 && (this.renderTargetA.texture.type = s,
        this.renderTargetB.texture.type = s,
        s !== O ? (this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1",
...
gl_FragColor=vec4(l*mask);
  ...
  , zt = class extends b {
    constructor({renderTarget: e, luminanceRange: t, colorOutput: s, resolutionScale: i=1, width: r=E.AUTO_SIZE, height: n=E.AUTO_SIZE, resolutionX: a=r, resolutionY: l=n}={}) {
        super("LuminancePass"),
        this.fullscreenMaterial = new Nt(s,t),
        this.needsSwap = !1,
        this.renderTarget = e,
        this.renderTarget === void 0 && (this.renderTarget = new U(1,1,{
            depthBuffer: !1
        }),
    ...
    initialize(e, t, s) {
        s !== void 0 && s !== O && (this.renderTarget.texture.type = s,
...
#include <colorspace_fragment>
  ...
  , Kt = class extends b {
    constructor() {
        ...
        this.downsamplingMaterial = new Lt,
        this.upsamplingMaterial = new Wt,
        this.resolution = new x
    }
    get texture() {
        return this.renderTarget.texture
    }
    ...
    render(e, t, s, i, r) {
        const {scene: n, camera: a} = this
          , {downsamplingMaterial: l, upsamplingMaterial: o} = this
          , {downsamplingMipmaps: c, upsamplingMipmaps: d} = this;
        let h = t;
    ...
    setSize(e, t) {
        ...
        for (let n = 0, a = this.downsamplingMipmaps.length; n < a; ++n)
            i = Math.round(i * .5),
            r = Math.round(r * .5),
            this.downsamplingMipmaps[n].setSize(i, r),
            n < this.upsamplingMipmaps.length && this.upsamplingMipmaps[n].setSize(i, r)
    }
    initialize(e, t, s) {
        if (s !== void 0) {
...
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(map,uv)*intensity;}`
  , jt = class extends ee {
    constructor({blendFunction: e=u.SCREEN, luminanceThreshold: t=1, luminanceSmoothing: s=.03, mipmapBlur: i=!0, intensity: r=1, radius: n=.85, levels: a=8, kernelSize: l=se.LARGE, resolutionScale: o=.5, width: c=E.AUTO_SIZE, height: d=E.AUTO_SIZE, resolutionX: h=c, resolutionY: S=d}={}) {
        super("BloomEffect", Xt, {
            blendFunction: e,
            uniforms: new Map([["map", new p(null)], ["intensity", new p(r)]])
        }),
        this.renderTarget = new U(1,1,{
            depthBuffer: !1
        }),
        this.renderTarget.texture.name = "Bloom.Target",
        this.blurPass = new Ot({
            kernelSize: l
        }),
        ...
        this.luminanceMaterial.smoothing = s,
        this.mipmapBlurPass = new Kt,
        this.mipmapBlurPass.enabled = i,
        this.mipmapBlurPass.radius = n,
    ...
    setSize(e, t) {
        ...
        s.setBaseSize(e, t),
        this.renderTarget.setSize(s.width, s.height),
        this.blurPass.resolution.copy(s),
        this.luminancePass.setSize(e, t),
        this.mipmapBlurPass.setSize(e, t)
    }
    initialize(e, t, s) {
        this.blurPass.initialize(e, t, s),
        this.luminancePass.initialize(e, t, s),
        this.mipmapBlurPass.initialize(e, t, s),
        s !== void 0 && (this.renderTarget.texture.type = s,
  ...
  , Me = class extends b {
    constructor(e, t, s=null) {
        ...
        this.needsSwap = !1,
        this.needsDepthBlit = !0,
        this.clearPass = new Re,
        this.overrideMaterialManager = s === null ? null : new ce(s),
    ...
    set overrideMaterial(e) {
        ...
        e !== null ? t !== null ? t.setMaterial(e) : this.overrideMaterialManager = new ce(e) : t !== null && (t.dispose(),
    ...
    render(e, t, s, i, r) {
        ...
        l !== null && a.layers.set(l.getLayer()),
...
gl_FragColor=vec4(n[index],d[index]);}`
  ...
  , Yt = class extends b {
    constructor({normalBuffer: e=null, resolutionScale: t=.5, width: s=E.AUTO_SIZE, height: i=E.AUTO_SIZE, resolutionX: r=s, resolutionY: n=i}={}) {
...
#include <dithering_fragment>
  ...
  , es = class extends F {
    ...
    setShaderParts(e) {
        return this.fragmentShader = qt.replace(f.FRAGMENT_HEAD, e.get(f.FRAGMENT_HEAD) || "").replace(f.FRAGMENT_MAIN_UV, e.get(f.FRAGMENT_MAIN_UV) || "").replace(f.FRAGMENT_MAIN_IMAGE, e.get(f.FRAGMENT_MAIN_IMAGE) || ""),
        this.vertexShader = Jt.replace(f.VERTEX_HEAD, e.get(f.VERTEX_HEAD) || "").replace(f.VERTEX_MAIN_SUPPORT, e.get(f.VERTEX_MAIN_SUPPORT) || ""),
        this.needsUpdate = !0,
        this
    }
    setDefines(e) {
    ...
    copyCameraSettings(e) {
        ...
        e instanceof Fe ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA,
        this.needsUpdate = !0)
    }
    setSize(e, t) {
        const s = this.uniforms;
        s.resolution.value.set(e, t),
        s.texelSize.value.set(1 / e, 1 / t),
        s.aspect.value = e / t
    }
    static get Section() {
        return f
...
function ue(e, t, s) {
    for (const i of t) {
        ...
        for (const a of s.entries())
            a[1] !== null && s.set(a[0], a[1].replace(n, r))
    }
}
function ts(e, t, s) {
    ...
    if (s.attributes |= t.getAttributes(),
    i === void 0)
        throw new Error(`Missing fragment shader (${t.name})`);
    if (a && s.attributes & C.CONVOLUTION)
...
`;
            for (const v of r.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
                for (const M of v[1].split(/\s*,\s*/))
                    s.varyings.add(M),
                    w.add(M),
                    R.add(M);
            for (const v of r.matchAll(l))
                R.add(v[1])
        }
        for (const g of i.matchAll(l))
            R.add(g[1]);
        for (const g of t.defines.keys())
            R.add(g.replace(/\([\w\s,]*\)/g, ""));
        for (const g of t.uniforms.keys())
            R.add(g);
        R.delete("while"),
        R.delete("for"),
        R.delete("if"),
        t.uniforms.forEach( (g, v) => s.uniforms.set(e + v.charAt(0).toUpperCase() + v.slice(1), g)),
        t.defines.forEach( (g, v) => s.defines.set(e + v.charAt(0).toUpperCase() + v.slice(1), g));
        const N = new Map([["fragment", i], ["vertex", r]]);
        ue(e, R, s.defines),
        ue(e, R, N),
        i = N.get("fragment"),
        r = N.get("vertex");
        const D = t.blendMode;
        if (s.blendModes.set(D.blendFunction, D),
        n) {
	...
	`),
            ...
            s.attributes & C.DEPTH && g.test(i) && (h += "depth, ",
            s.readDepth = !0),
            h += `color1);
	`;
            const v = e + "BlendOpacity";
            s.uniforms.set(v, D.opacity),
            h += `color0 = blend${D.blendFunction}(color0, color1, ${v});
...
`,
        r !== null && (S += r + `
`),
        o.set(f.FRAGMENT_HEAD, c),
        o.set(f.FRAGMENT_MAIN_UV, d),
        o.set(f.FRAGMENT_MAIN_IMAGE, h),
        o.set(f.VERTEX_HEAD, S),
        o.set(f.VERTEX_MAIN_SUPPORT, m),
        t.extensions !== null)
            for (const g of t.extensions)
                s.extensions.add(g)
    }
}
var ss = class extends b {
    constructor(e, ...t) {
        ...
        this.listener = s => this.handleEvent(s),
        this.effects = [],
        this.setEffects(t),
    ...
    updateMaterial() {
        ...
        for (const a of this.effects)
            if (a.blendMode.blendFunction === u.DST)
                e.attributes |= a.getAttributes() & C.DEPTH;
            else {
                if (e.attributes & a.getAttributes() & C.CONVOLUTION)
        ...
        for (const a of e.blendModes.values())
            s += a.getShaderCode().replace(n, `blend${a.blendFunction}`) + `
`;
...
` + r,
        ...
        e.shaderParts.set(f.FRAGMENT_HEAD, s),
        e.shaderParts.set(f.FRAGMENT_MAIN_IMAGE, i),
        e.shaderParts.set(f.FRAGMENT_MAIN_UV, r);
        for (const [a,l] of e.shaderParts)
            l !== null && e.shaderParts.set(a, l.trim().replace(/^#/, `
#`));
    ...
    initialize(e, t, s) {
        ...
        for (const i of this.effects)
            i.initialize(e, t, s);
        this.updateMaterial(),
        s !== void 0 && s !== O && (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1")
    }
    dispose() {
        super.dispose();
  ...
  , is = class extends b {
    constructor(e, t, {renderTarget: s, resolutionScale: i=1, width: r=E.AUTO_SIZE, height: n=E.AUTO_SIZE, resolutionX: a=r, resolutionY: l=n}={}) {
        super("NormalPass"),
        this.needsSwap = !1,
        this.renderPass = new Me(e,t,new Ce);
        const o = this.renderPass;
        o.ignoreBackground = !0,
        o.skipShadowMapUpdate = !0;
        const c = o.getClearPass();
        c.overrideClearColor = new ve(7829503),
...
const rs = A.createContext(null)
  ...
  , us = Y.memo(A.forwardRef( ({children: e, camera: t, scene: s, resolutionScale: i, enabled: r=!0, renderPriority: n=1, autoClear: a=!0, depthBuffer: l, enableNormalPass: o, stencilBuffer: c, multisampling: d=8, frameBufferType: h=He}, S) => {
    const {gl: m, scene: w, camera: R, size: N} = fe()
      , D = s || w
      , g = t || R
      , [v,M,z] = A.useMemo( () => {
        const P = Ue()
    ...
    , [g, m, l, c, d, h, D, o, i]);
    A.useEffect( () => v == null ? void 0 : v.setSize(N.width, N.height), [v, N]),
    we( (P, _) => {
        if (r) {
            const y = m.autoClear;
            m.autoClear = a,
        ...
        if (y && v) {
            ...
            for (let H = 0; H < B.length; H++) {
                ...
                if (k instanceof ee) {
                    ...
                    if (!de(k)) {
                        let j = null;
                        for (; (j = B[H + 1]) instanceof ee && !de(j); )
                            re.push(j),
                            H++
                    }
    ...
    return A.useImperativeHandle(S, () => v, [v]),
    q.jsx(rs.Provider, {
        value: _e,
...
const he = new WeakMap
  , as = (e, t) => Y.forwardRef(function({blendFunction: i=t == null ? void 0 : t.blendFunction, opacity: r=t == null ? void 0 : t.opacity, ...n}, a) {
    let l = he.get(e);
    if (!l) {
